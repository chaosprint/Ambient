...
pub mod audio{
  ...
  impl core::fmt::Debug for AudioListener {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      f.debug_struct("AudioListener").field("transform", &self.transform).field("ear-distance", &self.ear_distance).finish()
    }
  }
  #[allow(clippy::all)]
  pub fn load(url: &str,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_load")]
        fn wit_import(
        _: i32, _: i32, );
      }
  ...
  pub fn play(entity: EntityId,index: u32,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_play")]
        fn wit_import(
        _: i64, _: i64, _: i32, );
      }
  ...
  pub fn set_listener(entity: EntityId,listener: AudioListener,){
    ...
    unsafe {
      ...
      *((ptr0 + 8) as *mut i64) = wit_bindgen::rt::as_i64(id11);
      let AudioListener{ transform:transform2, ear_distance:ear_distance2, } = listener;
      let super::types::Mat4{ x:x3, y:y3, z:z3, w:w3, } = transform2;
      let super::types::Vec4{ x:x4, y:y4, z:z4, w:w4, } = x3;
      *((ptr0 + 16) as *mut f32) = wit_bindgen::rt::as_f32(x4);
      *((ptr0 + 20) as *mut f32) = wit_bindgen::rt::as_f32(y4);
      *((ptr0 + 24) as *mut f32) = wit_bindgen::rt::as_f32(z4);
      *((ptr0 + 28) as *mut f32) = wit_bindgen::rt::as_f32(w4);
      ...
      *((ptr0 + 76) as *mut f32) = wit_bindgen::rt::as_f32(w7);
      let super::types::Vec3{ x:x8, y:y8, z:z8, } = ear_distance2;
      ...
      *((ptr0 + 88) as *mut f32) = wit_bindgen::rt::as_f32(z8);
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_set-listener")]
        fn wit_import(
        _: i32, );
      }
      wit_import(ptr0);
  ...
  pub fn set_emitter(entity: EntityId,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_set-emitter")]
        fn wit_import(
        _: i64, _: i64, );
      }
