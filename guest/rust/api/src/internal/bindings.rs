...
pub mod audio{
  ...
  #[derive(Clone)]
  pub struct Sound<'a,> {
    /// The sound clip URL to play.
    pub url: &'a str,
    /// Whether or not this action should loop
    pub looping: bool,
  }
  impl<'a,> core::fmt::Debug for Sound<'a,> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      f.debug_struct("Sound").field("url", &self.url).field("looping", &self.looping).finish()
    }
  }
  #[allow(clippy::all)]
  pub fn load(sound: Sound<'_,>,){
    
    #[allow(unused_imports)]
    use wit_bindgen::rt::{alloc, vec::Vec, string::String};
    unsafe {
      let Sound{ url:url0, looping:looping0, } = sound;
      let vec1 = url0;
      ...
      wit_import(ptr1, len1, match looping0 { true => 1, false => 0 });
    }
  }
