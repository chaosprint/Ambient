                        ...
                        unsafe {
                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub mod audio{
                              ...
                              #[allow(clippy::all)]
                              pub fn spawn_on_world(path: &str,){
                                ...
                                unsafe {
                                  ...
                                  extern "C" {
                                    #[cfg_attr(target_arch = "wasm32", link_name = "spawn-on-world")]
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_spawn-on-world")]
                                    fn wit_import(
                                    _: i32, _: i32, );
                                  }
                                  wit_import(ptr0, len0);
