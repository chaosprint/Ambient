                        ...
                        unsafe {
                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub fn set_animation_controller(entity: EntityId,animation_controller: AnimationController<'_,>,){
                              ...
                              #[allow(clippy::all)]
                              pub fn lol() -> wit_bindgen::rt::string::String{
                                ...
                                unsafe {
                                  ...
                                  #[link(wasm_import_module = "entity")]
                                  extern "C" {
                                    #[cfg_attr(target_arch = "wasm32", link_name = "lol")]
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "entity_lol")]
                                    fn wit_import(
                                    _: i32, );
                                  }
                                  wit_import(ptr0);
