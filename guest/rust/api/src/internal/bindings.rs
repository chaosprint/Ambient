...
pub mod client_audiosys{
  ...
  pub fn play_sound(name: &str,){
    ...
    unsafe {
      ...
      #[link(wasm_import_module = "client-audiosys")]
      extern "C" {
        #[cfg_attr(target_arch = "wasm32", link_name = "play-sound")]
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "client-audiosys_play-sound")]
        fn wit_import(
        _: i32, _: i32, );
      }
