...
pub mod client_audiosys{
  ...
  #[allow(clippy::all)]
  pub fn add_sound(name: &str,url: &str,){
    ...
    unsafe {
      ...
      #[link(wasm_import_module = "client-audiosys")]
      extern "C" {
        #[cfg_attr(target_arch = "wasm32", link_name = "add-sound")]
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "client-audiosys_add-sound")]
        fn wit_import(
  ...
  pub fn get_sound(name: &str,){
    ...
    unsafe {
      ...
      #[link(wasm_import_module = "client-audiosys")]
      extern "C" {
        #[cfg_attr(target_arch = "wasm32", link_name = "get-sound")]
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "client-audiosys_get-sound")]
        fn wit_import(
        _: i32, _: i32, );
      }
                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                                ...
                                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                                  match self {
                                    Target::RemoteUnreliable => {
                                      f.debug_tuple("Target::RemoteUnreliable").finish()
                                    }
                                    Target::RemoteReliable => {
                                      f.debug_tuple("Target::RemoteReliable").finish()
                                    }
                            ...
                            pub mod server_message{
                              ...
                              pub enum Target<'a,>{
                                ...
                                RemoteTargetedUnreliable(&'a str),
                                RemoteTargetedReliable(&'a str),
                                LocalBroadcast,
                                Local(EntityId),
                              }
                                ...
                                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                                  match self {
                                    Target::RemoteBroadcastUnreliable => {
                                      f.debug_tuple("Target::RemoteBroadcastUnreliable").finish()
                                    }
                                    Target::RemoteBroadcastReliable => {
                                      f.debug_tuple("Target::RemoteBroadcastReliable").finish()
                                    }
                                    Target::RemoteTargetedUnreliable(e) => {
                                      f.debug_tuple("Target::RemoteTargetedUnreliable").field(e).finish()
                                    }
                                    Target::RemoteTargetedReliable(e) => {
                                      f.debug_tuple("Target::RemoteTargetedReliable").field(e).finish()
                                    }
                                    Target::LocalBroadcast => {
                                      f.debug_tuple("Target::LocalBroadcast").finish()
                                    }
                            ...
                            pub mod guest{
                              ...
                              pub unsafe fn call_exec<T: Guest>(arg0: f32,arg1: i32,arg2: i32,arg3: i32,arg4: i32,) {
                                    ...
                                    #[cfg(debug_assertions)]19 => super::component::Value::TypeOption({{match i32::from(*((base + 16) as *const u8)) {
                                      ...
                                      8 => super::component::OptionValue::TypeString(match i32::from(*((base + 24) as *const u8)) {
                                        ...
                                        1 => Some({
                                          ...
                                          {#[cfg(not(debug_assertions))]{String::from_utf8_unchecked(Vec::from_raw_parts(*((base + 28) as *const i32) as *mut _, len21, len21))}#[cfg(debug_assertions)]{String::from_utf8(Vec::from_raw_parts(*((base + 28) as *const i32) as *mut _, len21, len21)).unwrap()}}
                                        }),
                                        #[cfg(not(debug_assertions))]
                                        _ => core::hint::unreachable_unchecked(),
                                        #[cfg(debug_assertions)]
                                ...
                                wit_bindgen::rt::dealloc(base22, (len22 as usize) * 96, 8);
                                T::exec(arg0, {#[cfg(not(debug_assertions))]{String::from_utf8_unchecked(Vec::from_raw_parts(arg1 as *mut _, len0, len0))}#[cfg(debug_assertions)]{String::from_utf8(Vec::from_raw_parts(arg1 as *mut _, len0, len0)).unwrap()}}, result22);
                              }
