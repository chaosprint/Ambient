                        ...
                        unsafe {
                          ...
                          for (i, e) in vec50.into_iter().enumerate() {
                            ...
                            pub mod audio{
                              ...
                              pub type EntityId = super::types::EntityId;
                              #[allow(clippy::all)]
                              pub fn add_sound(index: u32,path: &str,){
                                ...
                                unsafe {
                                  ...
                                  extern "C" {
                                    ...
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_add-sound")]
                                    fn wit_import(
                                    _: i32, _: i32, _: i32, );
                                  }
                                  wit_import(wit_bindgen::rt::as_i32(index), ptr0, len0);
                                }
                              }
                              #[allow(clippy::all)]
                              pub fn play_sound_on_entity(entity: EntityId,path: &str,){
                                ...
                                unsafe {
                                  ...
                                  extern "C" {
                                    ...
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_play-sound-on-entity")]
                                    fn wit_import(
                                    _: i64, _: i64, _: i32, _: i32, );
                                  }
                                  wit_import(wit_bindgen::rt::as_i64(id00), wit_bindgen::rt::as_i64(id10), ptr1, len1);
                              ...
                              pub fn listener(){
                                ...
                                unsafe {
                                  ...
                                  #[link(wasm_import_module = "audio")]
                                  extern "C" {
                                    #[cfg_attr(target_arch = "wasm32", link_name = "listener")]
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_listener")]
                                    fn wit_import(
                                    );
                                  }
                                  wit_import();
                              ...
                              pub fn emitter(){
                                ...
                                unsafe {
                                  ...
                                  #[link(wasm_import_module = "audio")]
                                  extern "C" {
                                    #[cfg_attr(target_arch = "wasm32", link_name = "emitter")]
                                    #[cfg_attr(not(target_arch = "wasm32"), link_name = "audio_emitter")]
                                    fn wit_import(
                                    );
                                  }
                                  wit_import();
