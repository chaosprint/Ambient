...
pub mod audiosys{
  ...
  pub fn init(code: &str,) -> u32{
    ...
    unsafe {
      ...
      #[link(wasm_import_module = "audiosys")]
      extern "C" {
        #[cfg_attr(target_arch = "wasm32", link_name = "init")]
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audiosys_init")]
        fn wit_import(
        _: i32, _: i32, ) -> i32;
      }
  ...
  pub fn add_sound(name: &str,url: &str,){
    ...
    unsafe {
      ...
      extern "C" {
        ...
        #[cfg_attr(not(target_arch = "wasm32"), link_name = "audiosys_add-sound")]
        fn wit_import(
